...
//        $this->original = array_merge($this->original, $attributes);
    ...
    {
        return new DescendantsRelation($this->newModelQuery(), $this);
    }
    ...
    {
        return new AncestorsRelation($this->newModelQuery(), $this);
    }
    ...
    {
        return $this->applyNestedSetScope($this->newModelQuery(), $table);
    }
